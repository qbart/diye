...
static inline imdd_v4 imdd_v4_init_4f(float x, float y, float z, float w)
{
    imdd_v4 v;
    v.x = x;
    v.y = y;
...
static inline imdd_v4 imdd_v4_init_3f(float x, float y, float z)
{
    imdd_v4 v;
    v.x = x;
    v.y = y;
...
static inline imdd_v4 imdd_v4_init_1f(float s)
{
    imdd_v4 v;
    v.x = s;
    v.y = s;
...
static inline imdd_v4 imdd_v4_load_3f(float const *p) { return imdd_v4_init_3f(p[0], p[1], p[2]); }

static inline void imdd_v4_store_3f(float *p, imdd_v4 v)
{
    p[0] = v.x;
    p[1] = v.y;
    p[2] = v.z;
...
static inline imdd_v4 imdd_v4_set_x(imdd_v4 a, imdd_v4 b)
{
    a.x = b.x;
    return a;
}
static inline imdd_v4 imdd_v4_set_y(imdd_v4 a, imdd_v4 b)
{
    a.y = b.y;
    return a;
}
static inline imdd_v4 imdd_v4_set_z(imdd_v4 a, imdd_v4 b)
{
    a.z = b.z;
    return a;
}
static inline imdd_v4 imdd_v4_set_w(imdd_v4 a, imdd_v4 b)
{
    a.w = b.w;
    return a;
}

static inline imdd_v4 imdd_v4_mul_sign(imdd_v4 a, imdd_v4 b)
{
    imdd_v4 c;
...
static inline imdd_v4 imdd_v4_dot3(imdd_v4 a, imdd_v4 b) { return imdd_v4_init_1f(a.x * b.x + a.y * b.y + a.z * b.z); }

static inline imdd_v4 imdd_v4_cross(imdd_v4 a, imdd_v4 b)
{
    return imdd_v4_init_3f(a.y * b.z - a.z * b.y, a.z * b.x - a.x * b.z, a.x * b.y - a.y * b.x);
}

static inline imdd_v4 imdd_v4_normalize3(imdd_v4 a)
{
