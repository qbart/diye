...
static inline imdd_v4 imdd_v4_load_3f(float const *p) { return _mm_set_ps(0.f, p[2], p[1], p[0]); }
...
static inline imdd_v4 imdd_v4_select(imdd_v4 mask, imdd_v4 true_val, imdd_v4 false_val)
{
...
static inline imdd_v4 imdd_v4_dot3(imdd_v4 a, imdd_v4 b)
{
