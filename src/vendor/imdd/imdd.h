...
#define IMDD_APPROX_SHAPE_SIZE_IN_BYTES 64
    ...
    static inline void IMDD_VECTORCALL
    imdd_line(imdd_shape_store_t *store, imdd_zmode_enum_t zmode, imdd_v4 start, imdd_v4 end, uint32_t color)
    {
        imdd_v4 *data = NULL;
        imdd_reserve(store, IMDD_SHAPE_LINE, IMDD_STYLE_WIRE, zmode, color, 2, (void **)&data);
        if (data)
        {
            data[0] = start;
            data[1] = end;
    ...
    static inline void IMDD_VECTORCALL imdd_triangle(
        imdd_shape_store_t *store,
        imdd_style_enum_t style,
        imdd_zmode_enum_t zmode,
        imdd_v4 pos_a,
    ...
    {
        imdd_v4 *data = NULL;
        imdd_reserve(store, IMDD_SHAPE_TRIANGLE, style, zmode, color, 3, (void **)&data);
        if (data)
        {
            data[0] = pos_a;
            data[1] = pos_b;
    ...
    static inline void IMDD_VECTORCALL imdd_shape(
        imdd_shape_store_t *store,
        imdd_shape_enum_t shape,
        imdd_style_enum_t style,
        imdd_zmode_enum_t zmode,
    ...
    {
        imdd_v4 *data = NULL;
        imdd_reserve(store, shape, style, zmode, color, 3, (void **)&data);
        if (data)
        {
    ...
    static inline void IMDD_VECTORCALL imdd_aabb(
        imdd_shape_store_t *store,
        imdd_style_enum_t style,
        imdd_zmode_enum_t zmode,
        imdd_v4 min,
    ...
    {
        imdd_v4 *data = NULL;
        imdd_reserve(store, IMDD_SHAPE_AABB, style, zmode, color, 2, (void **)&data);
        if (data)
        {
            data[0] = min;
            data[1] = max;
    ...
    static inline void IMDD_VECTORCALL imdd_obb(
        imdd_shape_store_t *store,
        imdd_style_enum_t style,
        imdd_zmode_enum_t zmode,
        imdd_v4 x_axis_vec,
    ...
    static inline void IMDD_VECTORCALL imdd_sphere(
        imdd_shape_store_t *store,
        imdd_style_enum_t style,
        imdd_zmode_enum_t zmode,
    ...
    {
        imdd_v4 *data = NULL;
        imdd_reserve(store, IMDD_SHAPE_SPHERE, style, zmode, color, 1, (void **)&data);
        if (data)
        {
    ...
    static inline void IMDD_VECTORCALL imdd_ellipsoid(
        imdd_shape_store_t *store,
        imdd_style_enum_t style,
        imdd_zmode_enum_t zmode,
        imdd_v4 x_axis_vec,
    ...
    static inline void IMDD_VECTORCALL imdd_cone(
        imdd_shape_store_t *store,
        imdd_style_enum_t style,
        imdd_zmode_enum_t zmode,
        imdd_v4 x_axis_vec,
    ...
    static inline void IMDD_VECTORCALL imdd_cylinder(
        imdd_shape_store_t *store,
        imdd_style_enum_t style,
        imdd_zmode_enum_t zmode,
        imdd_v4 x_axis_vec,
    ...
    static inline void IMDD_VECTORCALL imdd_frustum(
        imdd_shape_store_t *store,
        imdd_style_enum_t style,
        imdd_zmode_enum_t zmode,
        imdd_v4 x_axis_vec,
